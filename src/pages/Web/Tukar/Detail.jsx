...
const Detailtukar = () => {
    ...
    useEffect(() => {
        const fetchRewardDetail = async () => {
            try {
                const response = await axios.get(`https://api-mijelin.rakis.my.id/api/rewards/${id}`);
    ...
    const handleTukar = async () => {
        try {
            ...
            const response = await axios.post('https://api-mijelin.rakis.my.id/api/reward-redemptions', {
