  ...
  useEffect(() => {
    if (token) {
      if (activeTab === "setor" && RiwayatData.setor.length === 0) {
        ...
        activeTab === "penukaran" &&
        RiwayatData.penukaran.length === 0
      ) {
      ...
      <div>
        ...
        <div className="flex items-center justify-center font-poppins m-auto gap-5 mt-5">
          ...
          <div
            ...
            className={`cursor-pointer ${
              activeTab === "penukaran" ? "font-semibold" : ""
            }`}
          >
            <p>Penukaran Mijel</p>
            {activeTab === "penukaran" && (
        ...
        {activeTab === "setor" && (
          <div
          data-aos="fade-up"
          className="card-riwayat penukaran-mijel mt-5 flex flex-col p-5"
        >
          {isLoading ? (
            <LoadingLottie />
          ) : (
